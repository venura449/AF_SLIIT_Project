      ...
      <div className="w-full max-w-md p-6 rounded-3xl relative z-10 bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl shadow-green-500/10 transform transition-all duration-500 hover:shadow-green-500/20">
          ...
          <button
            ...
            className={`flex-1 py-2 px-3 rounded-md text-sm font-medium transition-all duration-300 ${
              role === "Donor"
                ...
                : "text-green-300/70 hover:text-white hover:bg-white/10"
            }`}
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="flex items-start space-x-2 text-sm">
            ...
            <label
              htmlFor="agreeTerms"
              className="text-green-200/70 cursor-pointer"
            >
              I agree to the{" "}
              <a
                href="#"
                className="text-green-400 hover:text-green-300 border-b border-green-400/30"
              >
                Terms of Service
              </a>{" "}
              and{" "}
